...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <center><h1 class="page-header">Cari Berdasarkan NIM dari Mahasiswa</h1>
                    <form action="<?php echo base_url('index.php/Admin_SearchKHSController/search')?>" method="get" role="search">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Contoh : 3411151xxx" name="search" id="search">
