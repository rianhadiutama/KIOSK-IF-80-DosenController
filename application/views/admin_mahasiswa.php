                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php 
                                    if( ! empty($datamhs)){ // Jika data pada database tidak sama dengan empty (alias ada datanya)
                                        foreach($datamhs as $data){ // Lakukan looping pada variabel siswa dari controller
                                        echo "<tr>";
                                        echo "<td>".$data->NIM."</td>";
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>/index.php/Admin_MahasiswaController/fetch",
   method:"POST",
