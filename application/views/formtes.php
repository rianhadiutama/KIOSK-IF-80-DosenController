...
<body>
  ...
  <form method="post" action="<?php echo base_url("index.php/Admin_NilaiController/form"); ?>" enctype="multipart/form-data">
    <!-- 
  ...
  if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
    ...
    echo "<form method='post' action='".base_url("index.php/Admin_NilaiController/adaw")."'>";
